...
export default function Analyze() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="bg-background px-6 py-4 border-b">
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Analyze your last 2 weeks of emails</span>
                  </li>
                </ul>
                <Button 
                  variant="secondary"
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Analyze your last 3 months of emails</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-green-600"></div>
                    </div>
                    <span className="text-muted-foreground">Analyze your most recent emails</span>
                  </li>
                </ul>
                <Button 
                  className="w-full"
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Analyze your entire history of emails</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-green-600"></div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Gmail app integration</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center mt-0.5">
                      <div className="w-2 h-2 rounded-full bg-green-600"></div>
