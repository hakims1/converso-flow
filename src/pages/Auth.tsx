      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="gradient-card shadow-card">
          ...
          <CardContent className="space-y-6">
            ...
            <Button onClick={handleGoogleSignIn} disabled={isLoading} className="w-full bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 shadow-sm" size="lg">
